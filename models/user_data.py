...
class UserTitleData:
    ...
    Attributes:
        ...
        rating ([int, str]): User's rating for the title (1-5) or 'N/A' if not rated.
    """
    def __init__(self, watched=False, added_date=None, watched_date='', rating='N/A'):
        ...
        Args:
            ...
            added_date (str, optional): Timestamp of when the title was added
            watched_date (str, optional): Timestamp of when the title was watched
            rating ([int, str], optional): User's rating for the title (1-5) or 'N/A' if not rated.
        """
